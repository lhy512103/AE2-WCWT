...
public record CraftingLockPacket(boolean locked) implements CustomPacketPayload {
    ...
    public static final StreamCodec<ByteBuf, CraftingLockPacket> STREAM_CODEC =
            StreamCodec.ofMember(CraftingLockPacket::write, CraftingLockPacket::read);
    ...
    private static CraftingLockPacket read(ByteBuf buf) {
        return new CraftingLockPacket(buf.readBoolean());
    }
