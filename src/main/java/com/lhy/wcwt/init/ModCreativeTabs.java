...
public final class ModCreativeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> WCWT_TAB = CREATIVE_TABS.register("main",
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> addWcwtItems(output, false))
                    .build());
    ...
    public static void addWcwtItems(CreativeModeTab.Output output) {
        addWcwtItems(output, true);
    }

    public static void addWcwtItems(CreativeModeTab.Output output, boolean includeTerminalItems) {
        if (includeTerminalItems) {
